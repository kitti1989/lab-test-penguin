...
culmen_length_mm = st.slider('Select Input1', 0.0, 10.0, 0)
culmen_depth_mm = st.slider('Select Input1', 0.0, 10.0, 0)
flipper_length_mm = st.slider('Select Input1', 0.0, 10.0, 0)
body_mass_g = st.slider('Select Input1', 0.0, 10.0, 0)
